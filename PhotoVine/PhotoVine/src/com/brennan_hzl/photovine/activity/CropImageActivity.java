...
public class CropImageActivity extends Activity {
	...
	private void initImageView() {
		...
		imageSource = ImageLoader.getInstance().loadImageSync(image.imageUri, 
				new ImageSize(getResources().getDisplayMetrics().widthPixels, getResources().getDisplayMetrics().heightPixels),
				Sconstants.options);
		if (imageSource != null) {
